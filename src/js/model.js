...
const createRecipeObject = function (data) {
  // this help us to get data properly in console
...
export const loadSearchResults = async function (query) {
  try {
    ...
    // console.log(data);
    // creating new object to store data
...
export const deleteBookmark = function (id) {
  ...
  // mark cur recipe as NOT a bookmark
  ...
  try {
    ...
    const ingredients = Object.entries(newRecipe)
      ...
      .map(ing => {
        ...
        if (ingArr.length !== 3)
          throw new Error(
            'Wrong ingredient format, Please use a proper format'
          );
